...
- Token cost: 697 input · 172 output
...
- Grafana Infrastructure Provisioning
...
### Community 0 - "Agent Pipeline Logic"
Cohesion: 0.14
...
### Community 1 - "Governance and Access Control"
Cohesion: 0.16
...
### Community 2 - "Grafana Infrastructure Provisioning"
Cohesion: 0.22
...
### Community 4 - "Pipeline Execution API"
Cohesion: 0.17
...
### Community 8 - "Database Initialization"
Cohesion: 0.67
...
- **Why does `get_client()` connect `Governance and Access Control` to `Agent Pipeline Logic`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `get_role_scoped_view()` connect `Governance and Access Control` to `Pipeline Execution API`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `run_agent_once()` connect `Agent Pipeline Logic` to `Governance and Access Control`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **What connects `name`, `private`, `version` to the rest of the system?**
  _35 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Agent Pipeline Logic` be split into smaller, more focused modules?**
